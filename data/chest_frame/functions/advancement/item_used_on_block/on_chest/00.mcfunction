...
execute if entity @e[type=#chest_frame:item_frames,tag=cf.frame_check,nbt={ItemRotation:2b},limit=1] at @s run function chest_frame:advancement/item_used_on_block/on_chest/002
